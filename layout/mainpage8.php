...
<div id="jv-wrap-mid">
    ...
    <!-- end gmenu -->
	<!-- start index_banner -->
		<div class="jv-main_banner"><div class="jv-main_banner_nav"><jdoc:include type="modules" name="index_banner" /></div></div>
    <!-- end index_banner -->
	
	<!-- start path -->
		<!--
		<div id="jv-path"><jdoc:include type="module" name="breadcrumbs" />	
		...
		<div id="jv-maininside">
			...
			<div id="jv-content<?php echo $contentwidth; ?>"> 
				...
				<?php endif; ?>
			<jdoc:include type="component" /><br /><jdoc:include type="modules" name="debug" />
			</div>
		</div>
